...
def eval_flow_avg(gt_flows,
                  ...
                  cfg,
                  moving_masks=None,
                  write_img=False, writer=None, iter=None):
    ...
    if moving_masks:
        ...
        result += "{:10.4f}, {:10.4f}, {:10.4f}, {:10.4f}, {:10.4f}, {:10.4f}, {:10.4f}, {:10.4f} \n".format(
            ...
            error_rate / num)
        if writer:
            writer.add_scalar('eval_15/epe', error/num, iter)
            writer.add_scalar('eval_15/epe_noc', error_noc / num, iter)
            writer.add_scalar('eval_15/epe_occ', error_move / num, iter)
            writer.add_scalar('eval_15/epe_move', error_static / num, iter)
            writer.add_scalar('eval_15/epe_static', error_static / num, iter)
            writer.add_scalar('eval_15/move_err_rate', error_move_rate / num, iter)
            writer.add_scalar('eval_15/static_err_rate', error_static_rate / num, iter)
            writer.add_scalar('eval_15/err_rate', error_rate / num, iter)
        ...
        if writer:
            writer.add_scalar('eval_12/epe', error/num, iter)
            writer.add_scalar('eval_12/epe_noc', error_noc / num, iter)
            writer.add_scalar('eval_12/epe_occ', error_move / num, iter)
            writer.add_scalar('eval_12/move_err_rate', error_move_rate / num, iter)
        return result
