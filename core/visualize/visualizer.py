...
class Visualizer(object):
    ...
    def print_loss(self, loss_pack, writer, iter_=None):
        ...
        if 'pt_depth_loss' in loss_pack.keys():
            ...
            writer.add_scalar('train/loss_pixel', loss_pixel, iter_)
            writer.add_scalar('train/loss_ssim', loss_ssim, iter_)
            writer.add_scalar('train/loss_pt_depth', loss_pt_depth, iter_)
            writer.add_scalar('train/loss_pj_depth', loss_pj_depth, iter_)
            writer.add_scalar('train/loss_depth_smooth', loss_depth_smooth, iter_)
            print(str_)
        else:
            ...
            writer.add_scalar('train/loss_pixel', loss_pixel, iter_)
            writer.add_scalar('train/loss_ssim', loss_ssim, iter_)
            writer.add_scalar('train/loss_flow_smooth', loss_flow_smooth, iter_)
            writer.add_scalar('train/loss_flow_consis', loss_flow_consis, iter_)
