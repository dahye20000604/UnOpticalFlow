...
class Flying_Prepared(torch.utils.data.Dataset):
    def __init__(self, data_dir, num_scales=3, img_hw=(384, 512), num_iterations=None):
        super(Flying_Prepared, self).__init__()
